...
O que entrega:
TOSKINSTALLER entrega um único arquivo final que ao ser executado abre o instalador do programa adicionado pra encapsulamento ou janelas guias para escolher caminho de pasta, descompactar programa convertido em "portable" e criação de atalho em menu iniciar e área de trabalho.
